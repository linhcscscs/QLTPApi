...
[Index("MA_SO_GD", "ID_TRUONG", "MA_TRUONG", "MA_CAP_HOC", "MA_NAM_HOC", "MA_KHOI", "ID_HOC_SINH", "ID_NHOM_DIEM_DANH", "THANG", Name = "IX_KEY", IsUnique = true)]
...
public partial class DIEM_DANH_HS_NHOM
{
    [Key]
    ...
    [InverseProperty("DIEM_DANH_HS_NHOM")]
    ...
    [ForeignKey("ID_NHOM_DIEM_DANH")]
    [InverseProperty("DIEM_DANH_HS_NHOM")]
    public virtual NHOM_DIEM_DANH ID_NHOM_DIEM_DANHNavigation { get; set; }
