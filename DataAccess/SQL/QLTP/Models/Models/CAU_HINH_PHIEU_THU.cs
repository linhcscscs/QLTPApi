...
[Index("MA_SO_GD", "MA_TRUONG", "MA_CAP_HOC", "MA_NAM_HOC", "KEY", Name = "MA_SO_GD_MA_TRUONG_MA_CAP_HOC_MA_NAM_HOC_KEY", IsUnique = true)]
public partial class CAU_HINH_PHIEU_THU
{
    [Key]
    ...
    [InverseProperty("CAU_HINH_PHIEU_THU")]
