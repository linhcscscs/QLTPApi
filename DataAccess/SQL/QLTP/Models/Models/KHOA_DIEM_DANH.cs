...
[Index("MA_SO_GD", "ID_TRUONG", "MA_TRUONG", "MA_CAP_HOC", "MA_NAM_HOC", "HOC_KY", "THANG", "NAM", "MA_KHOI", "ID_LOP", "MA_LOP", Name = "IX_KEY", IsUnique = true)]
...
public partial class KHOA_DIEM_DANH
{
    [Key]
    ...
    public int? SL_THU { get; set; }

    public int? SL_SU_DUNG { get; set; }

    [ForeignKey("ID_LOP")]
    [InverseProperty("KHOA_DIEM_DANH")]
